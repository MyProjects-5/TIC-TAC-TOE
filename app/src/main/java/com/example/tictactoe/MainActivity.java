...
public class MainActivity extends AppCompatActivity {
    ...
    private final List<int[]> combinatonList = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        combinatonList.add(new int[] {0,1,2});
        combinatonList.add(new int[] {3,4,5});
        combinatonList.add(new int[] {6,7,8});
        combinatonList.add(new int[] {0,3,6});
        combinatonList.add(new int[] {1,4,7});
        combinatonList.add(new int[] {2,5,8});
        combinatonList.add(new int[] {2,4,6});
        combinatonList.add(new int[] {0,4,8});
    ...
    private void changePlayerTurn(int currentPlayerTurn) {
        ...
        private boolean checkResults(){
            ...
            for (int i = 0; i < combinatonList.size(); i++) {
                final int[] combination = combinatonList.get(i);
